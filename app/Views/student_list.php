...
<html lang="en">
<head>
<title>Codeigniter 4 CRUD Jquery Ajax Bootstrap 5 Modal</title>
<meta charset="utf-8">
...
<div class="container"><br/><br/>
    <div class="row">
        <div class="col-lg-10">
            <h2>Codeigniter 4 CRUD Jquery Ajax Bootstrap 5 Modal</h2>
        </div>
        <div class="col-lg-2">
    ...
    $('body').on('click', '.btnEdit', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $('#updateStudent #txtName').val(res.data.name);
